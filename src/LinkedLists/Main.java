...
public class Main {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 1 -> {
                    ...
                    if (choice_ == 1) {
                        linkedList = createLinkedList("integer");
                        TYPE_CHOICE = 1;
                        System.out.println("LinkedList created successfully.");
                    } else if (choice_ == 2) {
                        linkedList = createLinkedList("double");
                        TYPE_CHOICE = 2;
                        System.out.println("LinkedList created successfully.");

                    } else if (choice_ == 3) {
                        linkedList = createLinkedList("float");
                        TYPE_CHOICE = 3;
                        System.out.println("LinkedList created successfully.");
    ...
    public static LL<?> createLinkedList(String type) {
        return switch (type) {
            case "integer" -> new LL<Integer>();
            case "string" -> new LL<String>();
            case "float" -> new LL<Float>();
            case "double" -> new LL<Double>();
            default -> null;
        };
    }
}